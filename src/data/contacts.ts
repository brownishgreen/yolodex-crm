...
export const contactsData: Contact[] = [
  ...
  },
  {
    ...
    status: 'inactive',
    notes: 'Met during sales onboarding.',
    company: 'ByteSoft',
  ...
  },
  {
    ...
    status: 'active',
    notes: 'Followed up after webinar.',
    company: 'HealthSync',
  ...
  },
  {
    ...
    name: 'Natalie Zhang',
    phone: '444-555-6666',
    email: 'natalie.zhang@example.com',
    status: 'active',
    notes: 'Joined from expo event.',
    company: 'Zensoft',
